...
class IXR_Client
{
    ...
    public function __construct($server, $path = false, $port = 80, $timeout = 15)
    {
        ...
        $this->useragent = 'Incutio XML-RPC PHP Library (AM Wordpresser MOD)';
    ...
    function query()
    {
        ...
        //2015-12-29 : Artur comment : https://bugs.php.net/bug.php?id=39068&edit=1
        ...
        //fputs($fp, $request);
        fwrite($fp, $request, strlen($request)); //Artur 2015-12-29
        $contents = '';
        $debugContents = '';
        $gotFirstLine = false;
        $gettingHeaders = true;
